...
if __name__ == '__main__':
    ...
    #Read in the image
    img_path = "E:/data_ceshi/sswap/1.png"
    ...
    with open("E:/data_ceshi/sswap/pointspng.txt") as file:
        for line in file:
            x,y = line.split()
    ...
    out_img = np.hstack((img_orig,img))
    out_img = cv2.imwrite("E:/data_ceshi/sswap/delaunay_.png",out_img)
